...
SELECT * FROM READING_LOG_LIKE WHERE USER_ID = 'user05';

INSERT INTO READING_LOG_LIKE (LOG_IDX, USER_ID) VALUES(91, 'user05');

SELECT * FROM READING_LOG_LIKE WHERE LOG_IDX = 91;
...
SELECT * FROM READING_LOG WHERE USER_ID = 'user01';
...
SELECT CONCAT(BOOK_IDX, ', ', TITLE, ', ', GENRE) AS book_info
FROM BOOK;

SELECT * FROM QUOTE WHERE USER_ID = 'user01';
...
SELECT * FROM READING_LOG WHERE USER_ID = 'user05';
...
SHOW CREATE TABLE READING_LOG_LIKE;
