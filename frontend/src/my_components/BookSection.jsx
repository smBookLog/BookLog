...
const BookSection = () => {
    ...
    const [readingStatus, setReadingStatus] = useState('독서 완료');
                            ...
                            books
                                ...
                                .map((book) => (
                                    <div key={book.logIdx} className="book-item">
                                        <div className="book-cover" style={{ borderRadius: '0px', margin: '0px', maxHeight: '170px', maxWidth: '130px', objectFit: 'cover', backgroundColor: 'transparent', border: 'none' }}>
                                            <img
                                                src={book.bookImgUrl}
                                                alt={book.title}
